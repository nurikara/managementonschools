...
//
    ...
    public void adminStudentIcinPostRequestYap(String advisorTeacherId, String birthDay, String birthPlace, String email, String fatherName, String gender, String motherName, String name, String surname, String phoneNumber, String ssn, String username, String password) {
        ...
        expectedDataa=new US15_p(advisorTeacherId,birthDay,birthPlace,email,fatherName,gender,motherName,name,surname,phoneNumber,ssn,username,password);
        //Send the request and get the response
        responseerel = given(spec).body(expectedDataa).header("Authorization", generateToken((String) ConfigReader.getProperty("ErelusernameAdmin"), (String) ConfigReader.getProperty("ErelpasswordAdmin"))).post("{first}/{second}");
        responseerel.prettyPrint();
    }

    @Then("ADMİN body i dogrula")
    public void adminBodyIDogrula() {
        US15_ObjectPojo actualData = ObjectMapperUtils.convertJsonToJava(responseerel.asString(),US15_ObjectPojo.class);
        //  System.out.println("actualData = " + actualData);
        //   System.out.println("actualData.getObject().getUsername() = " + actualData.getObject().getUsername());
        // System.out.println("expectedDataa.getUsername() = " + expectedDataa.getUsername());
    ...
    public void adminSendGetRequestToUrlById_() {
        ...
        spec.pathParams("first", "students", "second", "getStudentById").queryParam("id",userId);
        responseerel = given(spec).header("Authorization", generateToken((String) ConfigReader.getProperty("ErelusernameAdmin"), (String) ConfigReader.getProperty("ErelpasswordAdmin")))
                .get("{first}/{second}");
